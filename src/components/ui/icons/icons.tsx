...
export function IconCamera() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
      <path
        d="M4 8a2 2 0 0 1 2-2h2.1a2 2 0 0 0 1.7-.9l.4-.6a2 2 0 0 1 1.7-.9h2.2a2 2 0 0 1 1.7.9l.4.6a2 2 0 0 0 1.7.9H18a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V8Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinejoin="round"
      />
...
export function IconSun() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
      ...
      />
      <path
        d="M4.9 4.9l2.1 2.1M17 17l2.1 2.1M19.1 4.9 17 7M7 17 4.9 19.1"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
...
export function IconShare() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
      ...
      <path
        d="M8.25 11l7-4.25M8.25 13l7 4.25"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
...
export function IconTrophyGold({
  size = 24,
  className = '',
...
export function IconTrophySilver({
  size = 24,
  className = '',
}: { size?: number; className?: string } = {}) {
  return (
...
export function IconTrophyBronze({
  size = 24,
  className = '',
}: { size?: number; className?: string } = {}) {
  return (
