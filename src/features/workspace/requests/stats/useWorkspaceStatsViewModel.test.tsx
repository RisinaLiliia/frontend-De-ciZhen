...
function createPersonalizedOverviewData(): WorkspaceStatisticsOverviewSourceDto {
  ...
  return {
    ...
    decisionLayer: {
      title: 'User vs Markt',
      subtitle: 'Backend decision layer',
      metrics: [
        {
          id: 'offer_rate',
          label: 'Offer rate',
          ...
          primaryActionCode: 'focus_market',
          summary: '24 pp unter dem Markt',
        },
        {
          ...
          summary: 'langsamer als der Markt',
        },
        {
          ...
          summary: 'Zu viele offene Anfragen',
        },
        {
          id: 'completed_jobs',
        ...
        },
        {
          ...
          direction: 'better',
          status: 'good',
          signalCodes: ['price_above_market'],
          primaryActionCode: 'adjust_price',
          summary: null,
        },
      ],
      primaryInsight: 'Antwortzeit und Angebotsquote liegen unter dem Markt.',
      primaryAction: {
        code: 'respond_faster',
        label: 'Antworte schneller',
        target: '/workspace?section=requests&scope=my',
      },
    },
    funnelComparison: {
      comparisonLabel: null,
      summary: 'Du verlierst im Antwortschritt mehr Anfragen als der Markt.',
      largestGapStage: 'offers',
      largestDropOffStage: 'responses',
      primaryBottleneck: 'Responses',
      nextAction: 'focus_market',
      stages: [
        {
          key: 'requests',
          label: 'Anfragen',
        ...
        },
        {
          ...
          marketCount: 13,
          userCount: 18,
          marketRateFromPrev: 54,
          userRateFromPrev: 31,
          gapRate: -23,
          status: 'below_market',
          recommendation: 'focus_market',
        },
        {
          key: 'responses',
          label: 'Antworten',
    ...
    userIntelligence: {
      comparisonLabel: null,
      formulaMetrics: [
        { key: 'offer_rate', unit: 'percent', marketValue: 55, userValue: 31, tone: 'warning' },
        { key: 'avg_response_time', unit: 'minutes', marketValue: 45, userValue: 930, tone: 'warning' },
        { key: 'revenue', unit: 'currency', marketValue: 1510, userValue: 3150, tone: 'positive' },
        { key: 'avg_order_value', unit: 'currency', marketValue: 302, userValue: 450, tone: 'positive' },
      ],
      decisionMetrics: [
        { key: 'response_time', unit: 'minutes', marketValue: 45, userValue: 930, tone: 'warning', status: 'high' },
        { key: 'unanswered', unit: 'count', marketValue: 2, userValue: 28, tone: 'warning', status: 'high' },
      ],
      signals: [
        {
...
describe('useWorkspaceStatsViewModel', () => {
  ...
  it('maps canonical user intelligence for personalized analysis mode', () => {
    render(<Probe data={createPersonalizedOverviewData()} isLoading={false} isError={false} />);
