...
type Props = Pick<WorkspaceContentPanelsProps, 't' | 'myOffersState' | 'myOffersListProps'>;

export function WorkspaceOffersTabPanel({ t, myOffersState, myOffersListProps }: Props) {
  return (
