...
export const workspaceNavigationItems: ReadonlyArray<WorkspaceNavigationItem> = [
  ...
  { section: 'offers', label: 'Angebote', href: '/workspace?section=requests&scope=my&role=provider&period=90d&range=90d', icon: MessageSquare, group: 'main' },
  { section: 'contracts', label: 'Aufträge', href: '/workspace?section=requests&scope=my&state=execution&period=90d&range=90d', icon: ClipboardList, group: 'main' },
