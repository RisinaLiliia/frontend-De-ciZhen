...
export const COPY_EN: WorkspaceStatisticsCopy = {
  ...
  contextSubtitle:
    'One shared market filter drives KPI, opportunities, pricing, and recommendations.',
  ...
  backgroundErrorBody:
    'The visible data still comes from the previous analysis context. Please try the refresh again.',
  ...
  priceRecommendationFallbackTemplate:
    'The range {range} currently shows the highest close rate{citySuffix}.',
  ...
  decisionReasonMarketBalanceTemplate:
    'Strong demand with relatively low provider pressure ({ratio}x market balance).',
  decisionReasonDemandProvidersTemplate:
    '{demand} demand signals currently meet only {providers} active providers.',
  ...
  decisionReasonPriceCorridorTemplate:
    'The {range} pricing corridor is currently supported by market data.',
  ...
  userGapSummaryTemplate:
    'You lose {percent}% between offer → response. That currently affects {count} cases.',
  ...
  userPositionSummaryTemplate:
    'You currently rank around the {percentile}th percentile versus the market.',
  ...
  userRiskVisibilityBody:
    'Your profile is only {profile}% complete. That reduces visibility and trust.',
  ...
  userOpportunityCompetitionBody:
    '{city} · {category} currently has favorable demand-to-competition balance.',
