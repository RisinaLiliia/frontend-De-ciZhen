...
export function WorkspaceProfileRail({ t, locale }: WorkspaceProfileRailProps) {
  ...
  return (
    <WorkspaceSectionAside className="workspace-profile-rail" model={model} isLoading={isLoading} />
  );
}
